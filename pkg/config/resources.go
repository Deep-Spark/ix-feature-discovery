...
const (
	ResourceNamePrefix    = "iluvatar.com"
...
type Resource struct {
	Pattern ResourcePattern `json:"pattern" static:"pattern"`
	Name    ResourceName    `json:"name"    static:"name"`
}

// Resources lists GPU devices
type Resources struct {
	GPUs []Resource `json:"gpus"           static:"gpus"`
}
